...
A roguelike game based off of the libtcod tutorial from http://rogueliketutorials.com/
...
def main():
    """
    Main loop and main menu handling
    """
    ...
    main_menu_background_image = libtcod.image_load('main_menu_bg.png')
...
def play_game(player, entities, game_map, message_log, game_state, con, panel, constants):
    ...
    while not libtcod.console_is_window_closed():
        ...
        # handle actions from keyboard/mouse
