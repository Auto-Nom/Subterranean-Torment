"""
Functions for drawing and clearing the screen in Subterranean Torment
"""
...
def render_bar(panel, x, y, total_width, name, value, maximum, bar_color, back_color):
    """
    Bar for displaying a stat with its value and max value
    """
...
def render_all(con, panel, entities, player, game_map, fov_map, fov_recompute, message_log, screen_width, screen_height, bar_width, panel_height, panel_y, mouse, colors, game_state):
    ...
    if game_state in (GameStates.SHOW_INVENTORY, GameStates.DROP_INVENTORY, GameStates.ACTIVATE_INVENTORY, GameStates.EQUIP_INVENTORY):
        if game_state == GameStates.SHOW_INVENTORY:
            ...
            inventory_title = 'Press the key next to an item to use it, or Esc to cancel.\n'
        if game_state == GameStates.EQUIP_INVENTORY:
